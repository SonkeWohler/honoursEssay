...
\begin{document}
  ...
  \section{The Role of Machine Learning}
    ...
    ML is perhaps the most championed approach to many problems, from image recognition to automatic decision making. While ML is a very vague and broad subject, by-enlarge it boils down to the application of maths that will, often making use of randomness, find the correct solution to a problem, or at least as close as possible to it.
    \\\\
